...
async function createByName(name, entityName) {
...
async function createManyToManyData(products) {
  ...
  return Promise.all([
    ...Object.keys(developers).map((name) => createByName(name, "developer")),
    ...Object.keys(publishers).map((name) => createByName(name, "publisher")),
    ...Object.keys(categories).map((name) => createByName(name, "category")),
    ...Object.keys(platforms).map((name) => createByName(name, "platform")),
  ]);
}
